...
```
cd existing_repo
git remote add origin https://gitlab.com/m2m-wordpress/pansophy.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/m2m-wordpress/pansophy/-/settings/integrations)
