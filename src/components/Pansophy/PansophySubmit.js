...
import { getQuestion, getAnswer, setChat } from "../../Store/chatSlice";
...
const PansophySubmit = ({
  ...
  const addAPIData = async () => {
    try {
      ...
      dispatch(getAnswer(generatedText));
      const data = {
        question: promptValue,
  ...
  const addImageAPIData = async () => {
    ...
    try {
      const payload = {
        question: promptValue,
        totalimgs: promptValueImages.name,
  ...
  return (
    <div
      className={`flex flex-col items-start p-4 bg-pansophy-bg rounded-xl md:flex-row md:items-center ${
        imagePrompt ? "md:divide-x md:divide-pansophy-divider" : ""
      }`}
    >
      <div className="flex items-center justify-between pb-2 w-full border-b border-pansophy-divider md:pb-0 md:border-0">
        <PansophyInput handleValue={handleValue} typing={typing} />

        <div className="flex md:hidden items-center space-x-2 pl-4">
      ...
      {/* const [promptValueSize, setPromptValueSize] = useState("");
  const [promptValueImages, setPromptValueImages] = useState(""); */}
      <div className="md:ml-auto grid grid-cols-2 w-full md:flex items-center mt-4 divide-x divide-pansophy-divider md:mt-0">
        {imagePrompt && (
          <>
            ...
            <div className="hidden md:block px-2 md:px-4 md:w-[190px]">
              <PansophySelect
                items={size_of_images}
                name="size_of_images"
            ...
            <div className="block md:hidden px-2 md:px-4 md:w-[190px]">
              <PansophySelect
                value={promptValueSize}
                setValue={setPromptValueSize}
        ...
        <div className="hidden md:flex ml-auto items-center space-x-2 pl-4">
          <button type="button" onClick={() => setImagePrompt(!imagePrompt)}>
            <svg
              width="24"
              height="25"
            ...
            >
              ...
              />
              <path
                d="M2.67002 20.2C2.43002 20.2 2.19002 20.08 2.05002 19.87C1.82002 19.53 1.91002 19.06 2.26002 18.83L7.19002 15.52C8.27002 14.79 9.76002 14.88 10.74 15.71L11.07 16C11.57 16.43 12.42 16.43 12.91 16L17.07 12.43C18.13 11.52 19.8 11.52 20.87 12.43L22.5 13.83C22.81 14.1 22.85 14.57 22.58 14.89C22.31 15.2 21.84 15.24 21.52 14.97L19.89 13.57C19.39 13.14 18.54 13.14 18.04 13.57L13.88 17.14C12.82 18.05 11.15 18.05 10.08 17.14L9.75002 16.85C9.29002 16.46 8.53002 16.42 8.02002 16.77L3.09002 20.08C2.96002 20.16 2.81002 20.2 2.67002 20.2Z"
                fill="#3F3F46"
              />
            </svg>
          </button>
